...
const MainCards = ({ data }) => {
  return (
    <div className="w-64 rounded h-[60vh] max-lg:w-52  max-lg:h-[50vh] max-md:w-44 max-sm:w-[42vw] max-sm:h-[34vh] max-md:h-[45vh] max-md:px-0  max-md:py-0 py-2 px-3 overflow-hidden border-[1px] border-zinc-700">
